...
export default function AboutAgentPage() {
  ...
  return (
    <div className="bg-slate-50">
      <section className="bg-gradient-to-br from-violet-700 via-fuchsia-600 to-rose-500 text-white">
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 py-16">
          ...
          <p className="mt-5 text-lg text-violet-100 max-w-2xl">
          ...
          <button
            ...
            className="mt-8 inline-flex items-center gap-2 rounded-md bg-white text-violet-700 px-6 py-3.5 text-base font-semibold shadow-lg hover:bg-violet-50"
          >
